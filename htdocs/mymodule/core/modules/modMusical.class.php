 ...
 *
 *  \file       htdocs/mymodule/core/modules/modMusical.class.php
 *  \ingroup    mymodule
 ...
 */
class modMusical extends DolibarrModules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->description = "Module de test";
		// Used only if file README.md and README-LL.md not found.
		$this->descriptionlong = "Module de test - thème : Les instruments de musique ";

		$this->editor_name = 'Josselin';
		$this->editor_url = 'https://www.example.com';

		// Possible values for version are: 'development', 'experimental', 'dolibarr', 'dolibarr_deprecated' or a version string like 'x.y.z'
		$this->version = 'developpement';
